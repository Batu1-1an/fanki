    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-white/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Access your personalized flashcards, track your progress, and master new vocabulary with AI-powered learning.
            </p>
            ...
            <div className="flex items-center space-x-4 pt-6">
              ...
              <span className="text-sm text-blue-100">Join 1000+ active learners</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            {(error || urlError) && (
              <div className="rounded-lg bg-red-50 border border-red-200 p-3 sm:p-4">
                <div className="flex">
                  <div className="ml-3">
                    <h3 className="text-xs sm:text-sm font-medium text-red-800 leading-relaxed">
                      {error || urlError}
                    </h3>
                  </div>
                </div>
